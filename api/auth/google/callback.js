...
import { getOAuthClient } from '../../_lib/google.js';
...
export default async function handler(req, res) {
    ...
    try {
        ...
        const returnTo = cookies.sol_return_to && cookies.sol_return_to.startsWith('/')
            ? cookies.sol_return_to
        ...
        arr.push(cookie.serialize('sol_oauth_state', '', { path: '/', maxAge: 0 }));
        arr.push(cookie.serialize('sol_return_to', '', { path: '/', maxAge: 0 }));
